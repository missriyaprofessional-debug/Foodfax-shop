...
class OwnerOrder {
  ...
  factory OwnerOrder.fromJson(Map<String, dynamic> json) {
    ...
    return OwnerOrder(
      ...
      orderNumber: json['order_number'] as String? ?? '#${json['id'].toString().substring(0, 5).toUpperCase()}',
      ...
      subtotal: (json['subtotal'] as num?)?.toDouble() ?? (json['total_amount'] as num?)?.toDouble() ?? 0.0,
